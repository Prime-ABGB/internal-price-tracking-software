async function fetchData() {
  ...
  try {
    const response = await fetch("/ram/api");
...
function openPriceComparison(productSku) {
  fetch(`/ram/product-comparison?product=${encodeURIComponent(productSku)}`)
